...
from api_parque.Admin.Users.AddUsers.serializers import TableUsersSerializer
...
class TableUserAPiView(APIView):
    ...
    def post(self, request):
            ...
            try:
                ...
                paginated_executions = paginator.paginate_queryset(Users, request)

                # Serializar los datos paginados
                serializer = TableUsersSerializer(paginated_executions, many=True)
